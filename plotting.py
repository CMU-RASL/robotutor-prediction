...
def plot_probability(t, prob, legend, title, result, count_text, filename, plot_bool):
    ...
    if plot_bool:
        plt.show()
    plt.savefig("plots\probabilities\\"+filename)
    plt.close()
...
def plot_confusion_matrix(conf_mat, num_classes, legend, name, filename, plot_bool):
    ...
    if plot_bool:
        plt.show()
    plt.savefig("plots\confusion\\"+filename)
    plt.close()
...
def plot_rocs(fprs, tprs, thresh_arr, name, filename, plot_bool):
    ...
    if plot_bool:
        plt.show()
    plt.savefig("plots\\roc\\{}_roc.png".format(filename))
    plt.close()
...
def plot_accuracies(acc, thresh_arr,name, filename, plot_bool):
    ...
    if plot_bool:
        plt.show()
    plt.savefig("plots\\accuracy\\{}_acc.png".format(filename))
    plt.close()